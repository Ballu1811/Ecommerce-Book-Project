...
namespace Ecomm_BookProject_2.Areas.Admin.Controllers
{
    ...
    public class CompanyController : Controller
    {
        ...
        {
            var companyList = _unitOfWork.Company.Get(id);
            if (companyList == null)
                return Json(new { success = false, message = "Somthing Wrong while delete data" });
            _unitOfWork.Company.Remove(companyList);
            _unitOfWork.Save();
